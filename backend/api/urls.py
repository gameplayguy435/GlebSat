...
from .views import LoginView, RegisterView, NewsArticleView, CreateNewsArticleView, UpdateNewsArticleView, CategoryView, ImageView, CreateImageView, UpdateImageView
